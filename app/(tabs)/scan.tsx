...
import { fetchProductByBarcode } from '../../src/lib/productApi';
...
export default function ScanScreen() {
  ...
  if (!ready) {
    return (
      <View style={s.center}>
        <Text>Please grant camera permission to scan barcodes.</Text>
      </View>
    );
  }
  ...
  return (
    <View style={s.container}>
      ...
      <View style={s.overlayTop}>
        <Text style={s.text}>Point at a barcode / QR</Text>
      </View>
